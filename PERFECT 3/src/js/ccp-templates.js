// File: src/js/ccp-templates.js (New File)
// This file contains the main HTML structure for the CCP pop-up window.
// It is kept separate to make the rendering logic in ccp-ui.js cleaner and more focused.
                ...
                <div class="settings-body">
                    <div class="settings-group">
                        ...
                        <div class="toggle-group">
                            <label class="toggle-switch">
                                ...
                                <input type="checkbox" id="toggle-biller-info" data-setting="displayBillerInfo" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="toggle-switch">
                                <span>Contact Numbers</span>
                                <input type="checkbox" id="toggle-contact-info" data-setting="displayContactInfo" checked>
                                <span class="slider"></span>
                            </label>
                            <label class="toggle-switch">
                                <span>Caller Location</span>
                                <input type="checkbox" id="toggle-location-info" data-setting="displayLocationInfo" checked>
                                <span class="slider"></span>
                            </label>
                        </div>
                    </div>
                    <div class="settings-group">
                        ...
                        <select id="ringtone-interval-select">
                            ...
                            <option value="7">Every 7 seconds</option>
                            <option value="8">Every 8 seconds</option>
                            <option value="9">Every 9 seconds</option>
                    ...
                    <div class="settings-group">
                        ...
                        <div class="radio-group" id="ringtone-select-group">
                            <div>
                                <input type="radio" id="ringtone-default" name="ringtone" value="src/audio/ringtone.mp3">
                                <label for="ringtone-default">Default Ring</label>
                            </div>
                            <div>
                                <input type="radio" id="ringtone-alt" name="ringtone" value="src/audio/dtmf-tone.mp3">
                                <label for="ringtone-alt">Alternate Tone</label>
                            </div>
                        </div>
                    </div>
                    <div class="settings-group">
                        ...
                        <div class="radio-group" id="theme-select-group">
                            ...
                            <div>
                                ...
                                <label for="theme-green">Green</label>
                            </div>
                            <div>
                                <input type="radio" id="theme-red" name="theme" value="red">
                                <label for="theme-red">Red</label>
                            </div>
                             <div>
                                <input type="radio" id="theme-yellow" name="theme" value="yellow">
                                <label for="theme-yellow">Yellow</label>
                            </div>
                        </div>
                    </div>
                </div>

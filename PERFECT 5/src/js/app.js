...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const initializeCCPEvents = () => {
        ...
        const openTransferDialog = (label, rawNumber) => {
            ...
            // ::: FIX: Renders actual, clickable buttons for number choices to match the event listener contract :::
        ...
        // ::: FIX: This single, consolidated listener handles both transfer and copy actions, preventing duplicate handlers :::
